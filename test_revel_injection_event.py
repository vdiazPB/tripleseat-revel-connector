#!/usr/bin/env python3
"""
Test script to inject the last event into Revel with CLOSED status.
"""
import os
import sys
import json
...
async def test_revel_injection():
    """Test injecting event 55521609 into Revel with CLOSED status."""
    
    print("=" * 70)
    print("TEST: REVEL ORDER INJECTION")
    print("=" * 70)
    print()
    
    # Create test webhook payload with CLOSED status
    webhook_payload = {
        ...
        "event": {
            ...
            "status": "CLOSED",  # CHANGED FROM DEFINITE TO CLOSED FOR REVEL
            "site_id": 15691,
